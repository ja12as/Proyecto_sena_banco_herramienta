...
import { BusquedaCoordinador, crearUsuario , getAllusuario, getUsuario, Putusuario } from "../controllers/Usuarios/Usuario.controllers.js";
...
UsuarioRouter.get("/usuarios/busqueda", BusquedaCoordinador);
